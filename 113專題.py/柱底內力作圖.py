...
df_雙向 = pd.read_excel("C:\專題EXCEL新版\專題EXCEL\EYUL\EYUL水平雙向柱底內力.xlsx", header=1)
df_三向 = pd.read_excel("C:\專題EXCEL新版\專題EXCEL\EYUL\EYUL 三向柱底內力.xlsx", header=1)
...
# 取得輸入 EXCEL 檔案的路徑
input_path = "C:\專題EXCEL新版\專題EXCEL\EYUL"
...
# 繪製 P 圖
plot_graph("P (KN)", "P", "EYUL Column Bottom Force Diagram", os.path.join(output_dir, "EYUL 柱底內力圖.png"))

# 繪製 V2 圖
plot_graph("V2 (KN)", "V2", "EYUL Column Bottom V2 Diagram", os.path.join(output_dir, "EYUL 柱底V2內力圖.png"))

# 繪製 V3 圖
plot_graph("V3 (KN)", "V3", "EYUL Column Bottom V3 Diagram", os.path.join(output_dir, "EYUL 柱底V3內力圖.png"))

# 繪製 M2 圖
plot_graph("M2 (KN-m)", "M2", "EYUL Column Bottom M2 Diagram", os.path.join(output_dir, "EYUL 柱底M2內力圖.png"))

# 繪製 M3 圖
plot_graph("M3 (KN-m)", "M3", "EYUL Column Bottom M3 Diagram", os.path.join(output_dir,"EYUL 柱底M3內力圖.png"))
