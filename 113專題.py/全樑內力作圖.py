...
df_雙向 = pd.read_excel("C:\\EYUL\\全梁雙向三項內力\\EYUL水平雙向全樑內力.xlsx", header=1)
df_三向 = pd.read_excel("C:\\EYUL\\全梁雙向三項內力\\EYUL 三向主樑內力.xlsx", header=1)
...
def plot_graph(y_label, column, title, file_name):
    ...
    plt.show()
# 繪製 P 圖
plot_graph("P (KN)", "P", "EYUL Full Beam Biaxial Triaxial Force Diagram", "C:\\EYUL\\全梁雙向三項內力\\EYUL 全梁雙向三向內力圖.png")

# 繪製 V2 圖
plot_graph("V2 (KN)", "V2", "EYUL Full Beam Biaxial Triaxial V2 Diagram", "C:\\EYUL\\全梁雙向三項內力\\EYUL 全梁雙向三向V2圖.png")

# 繪製 V3 圖
plot_graph("V3 (KN)", "V3", "EYUL Full Beam Biaxial Triaxial V3 Diagram", "C:\\EYUL\\全梁雙向三項內力\\EYUL 全梁雙向三向V3圖.png")

# 繪製 M2 圖
plot_graph("M2 (KN-m)", "M2", "EYUL Full Beam Biaxial Triaxial M2 Diagram", "C:\\EYUL\\全梁雙向三項內力\\EYUL 全梁雙向三向M2圖.png")

# 繪製 M3 圖
plot_graph("M3 (KN-m)", "M3", "EYUL Full Beam Biaxial Triaxial M3 Diagram", "C:\\EYUL\\全梁雙向三項內力\\EYUL 全梁雙向三向M3圖.png")