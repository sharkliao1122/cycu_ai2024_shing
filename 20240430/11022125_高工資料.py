...
for i in range(0, 24):
    for j in range(0, 60, 5):
        ...
        # 將處理後的資料寫存入 C:\Users\User\OneDrive\桌面\AI與土木應用\highway2
        df.to_csv(f"C:\\Users\\User\\OneDrive\\桌面\\AI與土木應用\\highway2\\{i:02d}{j:02d}.csv", index=False)
        print(f"{i:02d}{j:02d}.csv 下載並處理成功")


# 設定目錄路徑C:\Users\User\OneDrive\桌面\AI與土木應用\highway2
directory = "C:\\Users\\User\\OneDrive\\桌面\\AI與土木應用\\highway2"   
...
if dfs:
    ...
    df.to_csv(r"C:\Users\User\OneDrive\桌面\AI與土木應用\GitHub\cycu_ai2024_shing\20240430\M04A\20240429.csv", index=False)
